...
int mediaAritimetica(){
    int inteiro1 = 8, inteiro2 = 9, inteiro3 = 7, resultado;

    resultado = (inteiro1 + inteiro2 + inteiro3) / 3;
...
int leiaInteiro(){
    ...
    std::cout << inteiro1 << std::endl;
    std::cout << inteiro2 << std::endl;

    return 0;
}
// 3. Faça um programa que leia um número inteiro e exiba na tela seu sucessor e seu antecessor.
void Nsucessor(int numero1){
   std::cout << "Antecessor: " << numero1-- << std::endl;
   std::cout << "Sucessor: " << numero1++ << std::endl;
}
...
// altura.
// 33. Faça um programa que efetue o cálculo da quantidade de litros de combustível gastos em uma viagem, sabendo-se que o carro faz
